...
public class P714StockWithFee {
	 ...
	 * Favorite
	 * 
	 * Share Your are given an array of integers prices, for which the i-th element
	 ...
	 * profit is ((8 - 1) - 2) + ((9 - 4) - 2) = 8. Note:
	 * 
	 * 0 < prices.length <= 50000. 0 < prices[i] < 50000. 0 <= fee < 50000. Accepted
	 * 31,554 Submissions 64,383
	 */
